...
/////////////////
const BotName = 'MANKGRX BOT☄'; 
const instagram = 'https://instagram.com/mankgrx.co'; 
const telegram = 'https://t.me/Mankgrx69'; 
const kapanbotaktif = 'KETIKA GW AKTIF AJG'; 
const youtube = 'TEU BOGA YUTUB';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@mankgrx.co')
